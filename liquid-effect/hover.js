               ...
               if (r)
                    if (a && s && o) {
                         ...
                         var E,
                              ...
                              V = H.load(o, L);
                         if (
                              ((V.magFilter = V.minFilter = e.LinearFilter), y)
                         ) {
                              var M = function () {
                         ...
                         r.offsetHeight / r.offsetWidth < U
                              ? ((E = 1),
                                (W = r.offsetHeight / r.offsetWidth / U))
                              : ((E = (r.offsetWidth / r.offsetHeight) * U),
                                (W = 1));
